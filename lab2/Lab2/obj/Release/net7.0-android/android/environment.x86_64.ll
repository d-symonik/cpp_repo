...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"65ec04bb-2dae-478d-bf6b-70e59688c469\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100672587, ; jnienv_initialize_method_token
	i32 100672586, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.72 = internal constant [31 x i8] c"libaot-System.Text.Json.dll.so\00", align 16
...
@__DSOCacheEntry_name.80 = internal constant [19 x i8] c"libaot-Lab2.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [470 x %struct.DSOCacheEntry] [
	...
	; 286
	%struct.DSOCacheEntry {
		i64 11611506477277442829, ; hash 0xa1245b9ee544f30d, from name: Lab2.dll.so
		i8 0, ; ignore
	...
	; 295
	%struct.DSOCacheEntry {
		i64 11982662010527340642, ; hash 0xa64af79c990cd862, from name: Lab2
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.80, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 321
	%struct.DSOCacheEntry {
		i64 12883105360409746616, ; hash 0xb2c9fc1153275cb8, from name: libaot-Lab2
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.80, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 380
	%struct.DSOCacheEntry {
		i64 14850685755522610540, ; hash 0xce183c0328e0f56c, from name: aot-Lab2.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.80, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 387
	%struct.DSOCacheEntry {
		i64 15232349419372165225, ; hash 0xd3642d17ac4e3869, from name: aot-Lab2
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.80, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 388
	%struct.DSOCacheEntry {
		i64 15310312130292179704, ; hash 0xd47927c3d66b62f8, from name: libaot-Lab2.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.80, i32 0, i32 0), ; name
		i8* null; handle
	}, 
